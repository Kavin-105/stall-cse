...
export const kebab = {
    ...
    items: [
        ...
        { id: 6, name: 'Chicken Mint Kebab with roti', price: '₹110', description: 'Kebab stuffed in roti with onion , tomato and mayonnaise', image: roti },
        { id: 7, name: 'Chicken Pineapple Kebab with roti', price: '₹130', description: 'Kebab stuffed in roti with onion , tomato and mayonnaise', image: roti },
