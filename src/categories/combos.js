...
export const combos = {
    ...
    items: [
        ...
        { id: 3, name: 'Family Platter', price: '₹800', description: 'Serves 4 - Assorted kebabs, Fish, Prawns, and Rice.', image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&q=80&w=400' }
    ]
};
